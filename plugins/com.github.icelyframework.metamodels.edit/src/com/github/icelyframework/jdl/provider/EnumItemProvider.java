...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.jdl.Enum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JdlPackage.Literals.ENUM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JdlPackage.Literals.ENUM__LITERALS);
		}
	...
	public String getText(Object object) {
		String label = ((com.github.icelyframework.jdl.Enum)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(com.github.icelyframework.jdl.Enum.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JdlPackage.Literals.ENUM__LITERALS,
				 JdlFactory.eINSTANCE.createLiteral()));
	}
