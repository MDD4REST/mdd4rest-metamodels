...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.jdl.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JdlPackage.Literals.ENTITY__FIELDS);
			childrenFeatures.add(JdlPackage.Literals.ENTITY__RELATIONSHIPS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Entity.class)) {
			...
			case JdlPackage.ENTITY__RELATIONSHIPS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JdlPackage.Literals.ENTITY__FIELDS,
				 JdlFactory.eINSTANCE.createField()));

		newChildDescriptors.add
			(createChildParameter
				(JdlPackage.Literals.ENTITY__RELATIONSHIPS,
				 JdlFactory.eINSTANCE.createUnidirectionalRelationship()));

		newChildDescriptors.add
			(createChildParameter
				(JdlPackage.Literals.ENTITY__RELATIONSHIPS,
				 JdlFactory.eINSTANCE.createBidirectionalRelationship()));
	}
