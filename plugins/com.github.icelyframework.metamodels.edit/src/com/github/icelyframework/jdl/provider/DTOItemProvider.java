...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.jdl.DTO} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DTOItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DTO_entities_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DTO_entities_feature", "_UI_DTO_type"),
				 JdlPackage.Literals.DTO__ENTITIES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DTO_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DTO_value_feature", "_UI_DTO_type"),
				 JdlPackage.Literals.DTO__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		DTOValue labelValue = ((DTO)object).getValue();
