...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.deployment.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DeploymentPackage.Literals.PROJECT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DeploymentPackage.Literals.PROJECT__BASE_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DeploymentPackage.Literals.PROJECT__BASE_PACKAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeploymentPackage.Literals.PROJECT__APPLICATIONS);
			childrenFeatures.add(DeploymentPackage.Literals.PROJECT__DEPLOYMENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DeploymentPackage.Literals.PROJECT__APPLICATIONS,
				 DeploymentFactory.eINSTANCE.createApplication()));

		newChildDescriptors.add
			(createChildParameter
				(DeploymentPackage.Literals.PROJECT__DEPLOYMENT,
				 DeploymentFactory.eINSTANCE.createProjectDeployment()));
	}
