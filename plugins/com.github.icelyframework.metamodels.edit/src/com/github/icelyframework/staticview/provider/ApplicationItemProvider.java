...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.staticview.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StaticviewPackage.Literals.APPLICATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StaticviewPackage.Literals.APPLICATION__HAS_AGGREGATE);
			childrenFeatures.add(StaticviewPackage.Literals.APPLICATION__COMPLEXTYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StaticviewPackage.Literals.APPLICATION__HAS_AGGREGATE,
				 StaticviewFactory.eINSTANCE.createAggregate()));

		newChildDescriptors.add
			(createChildParameter
				(StaticviewPackage.Literals.APPLICATION__COMPLEXTYPES,
				 StaticviewFactory.eINSTANCE.createComplexType()));
	}
