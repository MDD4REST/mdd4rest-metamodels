...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.staticview.PrimitiveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimitiveTypeItemProvider extends SimpleTypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StaticviewPackage.Literals.PRIMITIVE_TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveType.class)) {
			case StaticviewPackage.PRIMITIVE_TYPE__TYPE:
