...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.staticview.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StaticviewPackage.Literals.PROJECT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StaticviewPackage.Literals.PROJECT__BASE_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StaticviewPackage.Literals.PROJECT__HAS_APPLICATION);
			childrenFeatures.add(StaticviewPackage.Literals.PROJECT__PRIMITIVE_TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StaticviewPackage.Literals.PROJECT__HAS_APPLICATION,
				 StaticviewFactory.eINSTANCE.createApplication()));

		newChildDescriptors.add
			(createChildParameter
				(StaticviewPackage.Literals.PROJECT__PRIMITIVE_TYPES,
				 StaticviewFactory.eINSTANCE.createPrimitiveType()));
	}
