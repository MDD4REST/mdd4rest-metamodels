...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.configuration.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationPackage.Literals.PROJECT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addBasePathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_basePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_basePath_feature", "_UI_Project_type"),
				 ConfigurationPackage.Literals.PROJECT__BASE_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationPackage.Literals.PROJECT__BASE_PACKAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addArchitecturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_architecture_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_architecture_feature", "_UI_Project_type"),
				 ConfigurationPackage.Literals.PROJECT__ARCHITECTURE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigurationPackage.Literals.PROJECT__APPLICATIONS);
			childrenFeatures.add(ConfigurationPackage.Literals.PROJECT__CONFIG);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.PROJECT__APPLICATIONS,
				 ConfigurationFactory.eINSTANCE.createApplication()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.PROJECT__CONFIG,
				 ConfigurationFactory.eINSTANCE.createProjectConfig()));
	}
