...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.configuration.ProjectConfig} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectConfigItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProjectConfig_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProjectConfig_version_feature", "_UI_ProjectConfig_type"),
				 ConfigurationPackage.Literals.PROJECT_CONFIG__VERSION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ProjectConfig)object).getVersion();
		return label == null || label.length() == 0 ?
			getString("_UI_ProjectConfig_type") :
