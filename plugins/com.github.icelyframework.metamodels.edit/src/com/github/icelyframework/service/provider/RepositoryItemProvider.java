...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.service.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Repository_repositoryDependencies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Repository_repositoryDependencies_feature", "_UI_Repository_type"),
				 ServicePackage.Literals.REPOSITORY__REPOSITORY_DEPENDENCIES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOtherDependenciesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Repository_otherDependencies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Repository_otherDependencies_feature", "_UI_Repository_type"),
				 ServicePackage.Literals.REPOSITORY__OTHER_DEPENDENCIES,
				 true,
				 false,
				 false,
	...
	protected void addGapClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Repository_gapClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Repository_gapClass_feature", "_UI_Repository_type"),
				 ServicePackage.Literals.REPOSITORY__GAP_CLASS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicePackage.Literals.REPOSITORY__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicePackage.Literals.REPOSITORY__OPERATIONS);
			childrenFeatures.add(ServicePackage.Literals.REPOSITORY__SUBSCRIBE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.REPOSITORY__OPERATIONS,
				 ServiceFactory.eINSTANCE.createRepositoryOperation()));

		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.REPOSITORY__SUBSCRIBE,
