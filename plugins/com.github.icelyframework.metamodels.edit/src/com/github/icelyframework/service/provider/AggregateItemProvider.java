...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.service.Aggregate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AggregateItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicePackage.Literals.AGGREGATE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicePackage.Literals.AGGREGATE__AGGREGATE_ROOT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicePackage.Literals.AGGREGATE__DOMAINOBJECTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.AGGREGATE__DOMAINOBJECTS,
				 ServiceFactory.eINSTANCE.createEntity()));

		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.AGGREGATE__DOMAINOBJECTS,
				 ServiceFactory.eINSTANCE.createValueObject()));

		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.AGGREGATE__DOMAINOBJECTS,
				 ServiceFactory.eINSTANCE.createBasicType()));

		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.AGGREGATE__DOMAINOBJECTS,
				 ServiceFactory.eINSTANCE.createCommandEvent()));

		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.AGGREGATE__DOMAINOBJECTS,
				 ServiceFactory.eINSTANCE.createEnumeration()));

		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.AGGREGATE__DOMAINOBJECTS,
				 ServiceFactory.eINSTANCE.createDTO()));

		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.AGGREGATE__DOMAINOBJECTS,
				 ServiceFactory.eINSTANCE.createDomainEvent()));
	}
