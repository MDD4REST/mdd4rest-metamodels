...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.service.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicePackage.Literals.APPLICATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicePackage.Literals.APPLICATION__COMPLEXTYPES);
			childrenFeatures.add(ServicePackage.Literals.APPLICATION__MODULES);
			childrenFeatures.add(ServicePackage.Literals.APPLICATION__ROLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.APPLICATION__COMPLEXTYPES,
				 ServiceFactory.eINSTANCE.createComplexType()));

		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.APPLICATION__MODULES,
				 ServiceFactory.eINSTANCE.createModule()));

		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.APPLICATION__ROLES,
				 ServiceFactory.eINSTANCE.createRole()));
	}
