...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.dynamicview.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DynamicviewPackage.Literals.APPLICATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DynamicviewPackage.Literals.APPLICATION__HAS_AGGREGATE);
			childrenFeatures.add(DynamicviewPackage.Literals.APPLICATION__COMPLEXTYPES);
			childrenFeatures.add(DynamicviewPackage.Literals.APPLICATION__HAS_ROLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DynamicviewPackage.Literals.APPLICATION__HAS_AGGREGATE,
				 DynamicviewFactory.eINSTANCE.createAggregate()));

		newChildDescriptors.add
			(createChildParameter
				(DynamicviewPackage.Literals.APPLICATION__COMPLEXTYPES,
				 DynamicviewFactory.eINSTANCE.createComplexType()));

		newChildDescriptors.add
			(createChildParameter
				(DynamicviewPackage.Literals.APPLICATION__HAS_ROLE,
				 DynamicviewFactory.eINSTANCE.createRole()));
	}
