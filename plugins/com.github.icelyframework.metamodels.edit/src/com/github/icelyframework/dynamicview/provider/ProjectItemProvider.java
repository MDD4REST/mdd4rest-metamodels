...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.dynamicview.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DynamicviewPackage.Literals.PROJECT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DynamicviewPackage.Literals.PROJECT__BASE_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAuthenticationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_authenticationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_authenticationType_feature", "_UI_Project_type"),
				 DynamicviewPackage.Literals.PROJECT__AUTHENTICATION_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DynamicviewPackage.Literals.PROJECT__HAS_APPLICATION);
			childrenFeatures.add(DynamicviewPackage.Literals.PROJECT__PRIMITIVE_TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DynamicviewPackage.Literals.PROJECT__HAS_APPLICATION,
				 DynamicviewFactory.eINSTANCE.createApplication()));

		newChildDescriptors.add
			(createChildParameter
				(DynamicviewPackage.Literals.PROJECT__PRIMITIVE_TYPES,
				 DynamicviewFactory.eINSTANCE.createPrimitiveType()));
	}
