...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.dynamicview.Access} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccessItemProvider extends PermissionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Access_access_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Access_access_feature", "_UI_Access_type"),
				 DynamicviewPackage.Literals.ACCESS__ACCESS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Access)object).getAccess();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Access.class)) {
			case DynamicviewPackage.ACCESS__ACCESS:
