...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.dynamicview.Policy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PolicyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Policy_eventType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Policy_eventType_feature", "_UI_Policy_type"),
				 DynamicviewPackage.Literals.POLICY__EVENT_TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DynamicviewPackage.Literals.POLICY__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Policy.class)) {
			case DynamicviewPackage.POLICY__NAME:
