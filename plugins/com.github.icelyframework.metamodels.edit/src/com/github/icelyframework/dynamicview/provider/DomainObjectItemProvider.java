...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.dynamicview.DomainObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainObjectItemProvider extends SimpleTypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DynamicviewPackage.Literals.DOMAIN_OBJECT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DynamicviewPackage.Literals.DOMAIN_OBJECT__AGGREGATE_ROOT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DynamicviewPackage.Literals.DOMAIN_OBJECT__HAS_OPERATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DynamicviewPackage.Literals.DOMAIN_OBJECT__HAS_OPERATION,
				 DynamicviewFactory.eINSTANCE.createDomainObjectOperation()));
	}
