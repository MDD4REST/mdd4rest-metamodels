...
/**
 * This is the item provider adapter for a {@link com.github.icelyframework.dynamicview.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DynamicviewPackage.Literals.PROCESS__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DynamicviewPackage.Literals.PROCESS__HAS_OPERATION);
		}
	...
	public String getText(Object object) {
		String label = ((com.github.icelyframework.dynamicview.Process)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(com.github.icelyframework.dynamicview.Process.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DynamicviewPackage.Literals.PROCESS__HAS_OPERATION,
				 DynamicviewFactory.eINSTANCE.createProcessOperation()));

		newChildDescriptors.add
			(createChildParameter
				(DynamicviewPackage.Literals.PROCESS__HAS_OPERATION,
				 DynamicviewFactory.eINSTANCE.createCommandOperation()));

		newChildDescriptors.add
			(createChildParameter
				(DynamicviewPackage.Literals.PROCESS__HAS_OPERATION,
				 DynamicviewFactory.eINSTANCE.createQueryOperation()));
	}
