...
/**
 * This is the item provider adapter for a {@link openapi2.ArrayContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayContainerItemProvider 
	 ...
	 * @generated
	 */
	public ArrayContainerItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		CollectionFormat labelValue = ((ArrayContainer)object).getCollectionFormat();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ArrayContainer_type") :
			getString("_UI_ArrayContainer_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ArrayContainer.class)) {
