...
/**
 * This is the item provider adapter for a {@link openapi2.Response} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResponseItemProvider extends SchemaContainerItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Openapi2Package.Literals.RESPONSE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Openapi2Package.Literals.RESPONSE__DECLARING_CONTEXT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSchemaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Response_schema_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Response_schema_feature", "_UI_Response_type"),
				 Openapi2Package.Literals.RESPONSE__SCHEMA,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Openapi2Package.Literals.RESPONSE__HEADERS);
			childrenFeatures.add(Openapi2Package.Literals.RESPONSE__EXAMPLES);
		}
	...
	public String getText(Object object) {
		String label = ((Response)object).getRef();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Openapi2Package.Literals.RESPONSE__HEADERS,
				 Openapi2Factory.eINSTANCE.createHeader()));

		newChildDescriptors.add
			(createChildParameter
				(Openapi2Package.Literals.RESPONSE__EXAMPLES,
				 Openapi2Factory.eINSTANCE.createExample()));
	}
