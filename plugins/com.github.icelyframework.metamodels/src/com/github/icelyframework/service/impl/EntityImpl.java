 ...
 * </p>
 * <ul>
 *   <li>{@link com.github.icelyframework.service.impl.EntityImpl#isAuditable <em>Auditable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends DomainObjectImpl implements Entity {
	...
	protected EClass eStaticClass() {
		return ServicePackage.Literals.ENTITY;
	}
	...
	public void setAuditable(boolean newAuditable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.ENTITY__AUDITABLE, oldAuditable, auditable));
	}
