 ...
 * </p>
 * <ul>
 *   <li>{@link com.github.icelyframework.service.impl.ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.github.icelyframework.service.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends EObjectImpl implements Parameter {
	...
	public TypeDefinition getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePackage.PARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(TypeDefinition newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.PARAMETER__TYPE, oldType, type));
	}
