 ...
 * </p>
 * <ul>
 *   <li>{@link com.github.icelyframework.service.impl.SubscribeImpl#getEventBus <em>Event Bus</em>}</li>
 *   <li>{@link com.github.icelyframework.service.impl.SubscribeImpl#getTopic <em>Topic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubscribeImpl extends EObjectImpl implements Subscribe {
	...
	protected EClass eStaticClass() {
		return ServicePackage.Literals.SUBSCRIBE;
	}
	...
	public void setEventBus(String newEventBus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.SUBSCRIBE__EVENT_BUS, oldEventBus, eventBus));
	}
	...
	public void setTopic(String newTopic) {
		...
		topic = newTopic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.SUBSCRIBE__TOPIC, oldTopic, topic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePackage.SUBSCRIBE__EVENT_BUS:
				return getEventBus();
			case ServicePackage.SUBSCRIBE__TOPIC:
				return getTopic();
		}
