...
public class RoleImpl extends EObjectImpl implements Role {
	...
	public Application getApplication() {
		if (eContainerFeatureID() != ServicePackage.ROLE__APPLICATION) return null;
	...
	public NotificationChain basicSetApplication(Application newApplication, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newApplication, ServicePackage.ROLE__APPLICATION, msgs);
		return msgs;
	}
	...
	public void setApplication(Application newApplication) {
		if (newApplication != eInternalContainer() || (eContainerFeatureID() != ServicePackage.ROLE__APPLICATION && newApplication != null)) {
			...
			if (newApplication != null)
				msgs = ((InternalEObject)newApplication).eInverseAdd(this, ServicePackage.APPLICATION__ROLES, Application.class, msgs);
			msgs = basicSetApplication(newApplication, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.ROLE__APPLICATION, newApplication, newApplication));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ServicePackage.ROLE__APPLICATION:
				return eInternalContainer().eInverseRemove(this, ServicePackage.APPLICATION__ROLES, Application.class, msgs);
		}
