 ...
 * </p>
 * <ul>
 *   <li>{@link com.github.icelyframework.service.impl.InheritanceImpl#getDiscriminatorColumnLength <em>Discriminator Column Length</em>}</li>
 *   <li>{@link com.github.icelyframework.service.impl.InheritanceImpl#getDiscriminatorType <em>Discriminator Type</em>}</li>
 *   <li>{@link com.github.icelyframework.service.impl.InheritanceImpl#getDiscriminatorColumnName <em>Discriminator Column Name</em>}</li>
 *   <li>{@link com.github.icelyframework.service.impl.InheritanceImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InheritanceImpl extends EObjectImpl implements Inheritance {
	...
	protected EClass eStaticClass() {
		return ServicePackage.Literals.INHERITANCE;
	}
	...
	public void setDiscriminatorColumnLength(String newDiscriminatorColumnLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.INHERITANCE__DISCRIMINATOR_COLUMN_LENGTH, oldDiscriminatorColumnLength, discriminatorColumnLength));
	}
	...
	public void setDiscriminatorType(DiscriminatorType newDiscriminatorType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.INHERITANCE__DISCRIMINATOR_TYPE, oldDiscriminatorType, discriminatorType));
	}
	...
	public void setDiscriminatorColumnName(String newDiscriminatorColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.INHERITANCE__DISCRIMINATOR_COLUMN_NAME, oldDiscriminatorColumnName, discriminatorColumnName));
	}
	...
	public void setType(InheritanceType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.INHERITANCE__TYPE, oldType, type));
	}
