 ...
 * </p>
 * <ul>
 *   <li>{@link com.github.icelyframework.dynamicview.impl.HasAnyAuthoritiesImpl#getRole <em>Role</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HasAnyAuthoritiesImpl extends PermissionImpl implements HasAnyAuthorities {
	...
	public EList<Role> getRole() {
		if (role == null) {
			role = new EObjectResolvingEList<Role>(Role.class, this, DynamicviewPackage.HAS_ANY_AUTHORITIES__ROLE);
		}
		return role;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DynamicviewPackage.HAS_ANY_AUTHORITIES__ROLE:
				return getRole();
		}
