 ...
 * </p>
 * <ul>
 *   <li>{@link com.github.icelyframework.dynamicview.impl.PolicyImpl#getEventType <em>Event Type</em>}</li>
 *   <li>{@link com.github.icelyframework.dynamicview.impl.PolicyImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PolicyImpl extends EObjectImpl implements Policy {
	...
	protected EClass eStaticClass() {
		return DynamicviewPackage.Literals.POLICY;
	}
		...
		if (eventType != null && eventType.eIsProxy()) {
			...
			if (eventType != oldEventType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DynamicviewPackage.POLICY__EVENT_TYPE, oldEventType, eventType));
			}
		}
		return eventType;
	}
	...
	public void setEventType(Event newEventType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DynamicviewPackage.POLICY__EVENT_TYPE, oldEventType, eventType));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DynamicviewPackage.POLICY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DynamicviewPackage.POLICY__EVENT_TYPE:
