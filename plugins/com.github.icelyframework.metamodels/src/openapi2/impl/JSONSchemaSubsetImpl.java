 ...
 * </p>
 * <ul>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getType <em>Type</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getUniqueItems <em>Unique Items</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getEnum <em>Enum</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link openapi2.impl.JSONSchemaSubsetImpl#getMultipleOf <em>Multiple Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class JSONSchemaSubsetImpl extends EObjectImpl implements JSONSchemaSubset {
	/**
	...
	protected EClass eStaticClass() {
		return Openapi2Package.Literals.JSON_SCHEMA_SUBSET;
	}
	...
	public void setType(JSONDataType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__TYPE, oldType, type));
	}
	...
	public void setFormat(String newFormat) {
		...
		format = newFormat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__FORMAT, oldFormat, format));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__DESCRIPTION, oldDescription, description));
	}
	...
	public void setMaximum(Double newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setExclusiveMaximum(Boolean newExclusiveMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__EXCLUSIVE_MAXIMUM, oldExclusiveMaximum, exclusiveMaximum));
	}
	...
	public void setMinimum(Double newMinimum) {
		...
		minimum = newMinimum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setExclusiveMinimum(Boolean newExclusiveMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__EXCLUSIVE_MINIMUM, oldExclusiveMinimum, exclusiveMinimum));
	}
	...
	public void setMaxLength(Integer newMaxLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__MAX_LENGTH, oldMaxLength, maxLength));
	}
	...
	public void setMinLength(Integer newMinLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__MIN_LENGTH, oldMinLength, minLength));
	}
	...
	public void setPattern(String newPattern) {
		...
		pattern = newPattern;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__PATTERN, oldPattern, pattern));
	}
	...
	public void setMaxItems(Integer newMaxItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__MAX_ITEMS, oldMaxItems, maxItems));
	}
	...
	public void setMinItems(Integer newMinItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__MIN_ITEMS, oldMinItems, minItems));
	}
	...
	public void setUniqueItems(Boolean newUniqueItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__UNIQUE_ITEMS, oldUniqueItems, uniqueItems));
	}
	...
	public EList<String> getEnum() {
		if (enum_ == null) {
			enum_ = new EDataTypeUniqueEList<String>(String.class, this, Openapi2Package.JSON_SCHEMA_SUBSET__ENUM);
		}
		return enum_;
	}
	...
	public void setDefault(String newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__DEFAULT, oldDefault, default_));
	}
	...
	public void setMultipleOf(Double newMultipleOf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi2Package.JSON_SCHEMA_SUBSET__MULTIPLE_OF, oldMultipleOf, multipleOf));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Openapi2Package.JSON_SCHEMA_SUBSET__TYPE:
				return getType();
			case Openapi2Package.JSON_SCHEMA_SUBSET__FORMAT:
				return getFormat();
			case Openapi2Package.JSON_SCHEMA_SUBSET__DESCRIPTION:
				return getDescription();
			case Openapi2Package.JSON_SCHEMA_SUBSET__MAXIMUM:
				return getMaximum();
			case Openapi2Package.JSON_SCHEMA_SUBSET__EXCLUSIVE_MAXIMUM:
				return getExclusiveMaximum();
			case Openapi2Package.JSON_SCHEMA_SUBSET__MINIMUM:
				return getMinimum();
			case Openapi2Package.JSON_SCHEMA_SUBSET__EXCLUSIVE_MINIMUM:
				return getExclusiveMinimum();
			case Openapi2Package.JSON_SCHEMA_SUBSET__MAX_LENGTH:
				return getMaxLength();
			case Openapi2Package.JSON_SCHEMA_SUBSET__MIN_LENGTH:
				return getMinLength();
			case Openapi2Package.JSON_SCHEMA_SUBSET__PATTERN:
				return getPattern();
			case Openapi2Package.JSON_SCHEMA_SUBSET__MAX_ITEMS:
				return getMaxItems();
			case Openapi2Package.JSON_SCHEMA_SUBSET__MIN_ITEMS:
				return getMinItems();
			case Openapi2Package.JSON_SCHEMA_SUBSET__UNIQUE_ITEMS:
				return getUniqueItems();
			case Openapi2Package.JSON_SCHEMA_SUBSET__ENUM:
				return getEnum();
			case Openapi2Package.JSON_SCHEMA_SUBSET__DEFAULT:
				return getDefault();
			case Openapi2Package.JSON_SCHEMA_SUBSET__MULTIPLE_OF:
