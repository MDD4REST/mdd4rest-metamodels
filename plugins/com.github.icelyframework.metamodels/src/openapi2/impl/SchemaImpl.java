 ...
 * </p>
 * <ul>
 *   <li>{@link openapi2.impl.SchemaImpl#getExternalDocs <em>External Docs</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getMaxProperties <em>Max Properties</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getMinProperties <em>Min Properties</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getExample <em>Example</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getDiscriminator <em>Discriminator</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getReadOnly <em>Read Only</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getAllOf <em>All Of</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getItems <em>Items</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getXml <em>Xml</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getAdditonalProperties <em>Additonal Properties</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getDeclaringContext <em>Declaring Context</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getAdditonalPropertiesAllowed <em>Additonal Properties Allowed</em>}</li>
 *   <li>{@link openapi2.impl.SchemaImpl#getTupleItems <em>Tuple Items</em>}</li>
 * </ul>
 *
 * @generated
 */
