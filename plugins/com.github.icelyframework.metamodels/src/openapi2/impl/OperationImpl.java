 ...
 * </p>
 * <ul>
 *   <li>{@link openapi2.impl.OperationImpl#getExternalDocs <em>External Docs</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getTagReferences <em>Tag References</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getOperationId <em>Operation Id</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getConsumes <em>Consumes</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getProduces <em>Produces</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getResponses <em>Responses</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getSchemes <em>Schemes</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getDeprecated <em>Deprecated</em>}</li>
 *   <li>{@link openapi2.impl.OperationImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
