 ...
 * </p>
 * <ul>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.EnumValueImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumValueImpl extends NamedElementImpl implements EnumValue {
	...
	public EList<EnumConstructorParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<EnumConstructorParameter>(EnumConstructorParameter.class, this, SculptormetamodelPackage.ENUM_VALUE__PARAMETERS);
		}
		return parameters;
	}
