 ...
 * </p>
 * <ul>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getReferences <em>References</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getExtends <em>Extends</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getModule <em>Module</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#isOptimisticLocking <em>Optimistic Locking</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#isCache <em>Cache</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getDatabaseTable <em>Database Table</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getExtendsName <em>Extends Name</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getValidate <em>Validate</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#isGapClass <em>Gap Class</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getInheritance <em>Inheritance</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getDiscriminatorColumnValue <em>Discriminator Column Value</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#isAggregateRoot <em>Aggregate Root</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getBelongsToAggregate <em>Belongs To Aggregate</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getOperations <em>Operations</em>}</li>
 *   <li>{@link org.sculptor.sculptormetamodel.impl.DomainObjectImpl#getTraits <em>Traits</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DomainObjectImpl extends NamedElementImpl implements DomainObject {
	...
	public EList<Reference> getReferences() {
		if (references == null) {
			references = new EObjectContainmentWithInverseEList<Reference>(Reference.class, this, SculptormetamodelPackage.DOMAIN_OBJECT__REFERENCES, SculptormetamodelPackage.REFERENCE__FROM);
		}
		return references;
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, SculptormetamodelPackage.DOMAIN_OBJECT__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public void setModule(org.sculptor.sculptormetamodel.Module newModule) {
		if (newModule != eInternalContainer() || (eContainerFeatureID() != SculptormetamodelPackage.DOMAIN_OBJECT__MODULE && newModule != null)) {
			...
			if (newModule != null)
				msgs = ((InternalEObject)newModule).eInverseAdd(this, SculptormetamodelPackage.MODULE__DOMAIN_OBJECTS, org.sculptor.sculptormetamodel.Module.class, msgs);
	...
	public EList<DomainObjectOperation> getOperations() {
		if (operations == null) {
			operations = new EObjectContainmentWithInverseEList<DomainObjectOperation>(DomainObjectOperation.class, this, SculptormetamodelPackage.DOMAIN_OBJECT__OPERATIONS, SculptormetamodelPackage.DOMAIN_OBJECT_OPERATION__DOMAIN_OBJECT);
		}
		return operations;
	}
	...
	public EList<Trait> getTraits() {
		if (traits == null) {
			traits = new EObjectResolvingEList<Trait>(Trait.class, this, SculptormetamodelPackage.DOMAIN_OBJECT__TRAITS);
		}
		return traits;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SculptormetamodelPackage.DOMAIN_OBJECT__MODULE:
				return eInternalContainer().eInverseRemove(this, SculptormetamodelPackage.MODULE__DOMAIN_OBJECTS, org.sculptor.sculptormetamodel.Module.class, msgs);
		}
