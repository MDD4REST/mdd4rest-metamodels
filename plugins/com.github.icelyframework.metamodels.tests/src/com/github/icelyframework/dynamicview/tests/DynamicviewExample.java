...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>dynamicview</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DynamicviewExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(DynamicviewPackage.eNS_URI, 
			 DynamicviewPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.dynamic"));
				Application root = DynamicviewFactory.eINSTANCE.createApplication();
